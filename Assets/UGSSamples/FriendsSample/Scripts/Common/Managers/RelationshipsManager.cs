...
namespace Unity.Services.Samples.Friends
{
    public class RelationshipsManager : MonoBehaviour
    {
        ...
        {
            m_LoggedPlayerProfile = new PlayerProfile(AuthenticationService.Instance.PlayerName, playerId);
        ...
        void RefreshRequests()
        {
            ...
            foreach (var request in requests)
            {
                m_RequestsEntryDatas.Add(
                    new PlayerProfile(request.Profile.Name, request.Id));
            }
        ...
        void RefreshBlocks()
        {
            ...
            {
                m_BlockEntryDatas.Add(new PlayerProfile(block.Member.Profile.Name,
                    block.Member.Id));
            }
        ...
        void SendFriendMessage(string playerID, FriendMessage msg)
        {
           FriendsService.Instance.MessageAsync(playerID, msg);
        }
    }
}